...
const UpdateForm = (props) => {
  return (
    <form className="form form-horizontal" id="addUpdateForm" onSubmit={props.addUpdate}>
      <div className="row">
        ...
        <FormGroup>
          <Button type="submit" onClick={props.toggleAddUpdate} bsStyle="success" bsSize="large" block>Submit</Button>
        </FormGroup>
    </form>
  );
}
